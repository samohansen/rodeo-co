...
CREATE TABLE "EventEntry" (
    ...
    CONSTRAINT "EventEntry_pkey" PRIMARY KEY ("participantId","eventId","horseName")
);
...
-- AddForeignKey
ALTER TABLE "Rodeo" ADD CONSTRAINT "Rodeo_adminId_fkey" FOREIGN KEY ("adminId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "EventEntry" ADD CONSTRAINT "EventEntry_participantId_fkey" FOREIGN KEY ("participantId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
